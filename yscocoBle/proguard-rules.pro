...
-keep class com.yscoco.blue.bean.** {*;}
-keep class com.yscoco.blue.enums.** {*;}
...
-keep class com.yscoco.blue.utils.LogBlueUtils {*;}
-keep class com.yscoco.blue.app.BaseBlueApplication {*;}
